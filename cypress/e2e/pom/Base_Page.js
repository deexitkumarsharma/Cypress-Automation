export class BasePage {
  ...
  expectedSoldOutItemAlertBoxText05 =
    "ll let you know when this item is back in stock.";
  expectedSoldOutItemAlertBoxText06 = "Continue shopping";

  ContinueBTnOnSoldOutAlert =
    ".modal-sold-out--is-open > .modal-sold-out-content > .modal-button";
  ...
  AssertSoldOutAlertBoxText() {
    cy.get(this.soldOutItemAlertBox)
      .should(
        "have.text",
        this.expectedSoldOutItemAlertBoxText01 +
          " " +
          this.expectedSoldOutItemAlertBoxText02 +
          "'" +
          this.expectedSoldOutItemAlertBoxText03 +
          " " +
          this.expectedSoldOutItemAlertBoxText04 +
          "'" +
          this.expectedSoldOutItemAlertBoxText05 +
          " " +
