export class EmailVerification {
  ...
  assertverificationMsg() {
    cy.get(this.actualVerificationMsg).should(
      "have.text",
      this.expectedVerificationMsg01 + "'" + this.expectedVerificationMsg02
    );
  }

  assertVerificationMsgWithEmail(email) {
    cy.get(this.actualVerificationMsgWithEmail).should(
      "have.text",
      this.expectedVerificationMsgWithEmail + email
    );
  }
}
